...
<div class="form-group">
    ...
    <asp:RegularExpressionValidator runat="server" ControlToValidate="txtMinScore" ForeColor="Red" ErrorMessage="Only Numbers Allowed" ValidationExpression="\d+" Display="Dynamic" />
</div>
<div class="form-group">
    ...
    <asp:RegularExpressionValidator runat="server" ControlToValidate="txtMaxScore" ForeColor="Red" ErrorMessage="Only Numbers Allowed" ValidationExpression="\d+" Display="Dynamic" />
</div>
<br />
<div class="form-group">
