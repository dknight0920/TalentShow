...
<div class="form-group">
    ...
    <asp:TextBox runat="server" ID="txtContestName" CssClass="form-control" MaxLength="255" />
...
<div class="form-group">
    ...
    <asp:DropDownList runat="server" ID="dropDownListStatus" CssClass="form-control" Width="280" >
