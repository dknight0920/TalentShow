...
namespace TalentShowWeb.Utils
{
    internal static class NavUtil
    {
        ...
        internal static string GetRegisterPageUrl()
        {
        ...
        internal static void GoToShowJudgeSheetReportPage(HttpResponse Response, int showId)
        {
            GoToPage(Response, GetShowJudgeSheetReportPageUrl(showId));
        }

        internal static string GetShowJudgeSheetReportPageUrl(int showId)
        {
        ...
        internal static string GetShowJudgeSheetReportPageUrl(int showId, int contestId, int contestantId)
        {
            return "~/Show/JudgeSheetReport.aspx?showId=" + showId + "&contestId=" + contestId + "&contestantId=" + contestantId;
        }
