...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        <h3 class="panel-title pull-left"><asp:Label runat="server" ID="panelTitle"></asp:Label> <span class="badge"><asp:Label runat="server" ID="panelTitleCountBadge"></asp:Label></span></h3>
        <% if (ShowAddButton) {%>
