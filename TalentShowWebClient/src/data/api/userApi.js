...
var updatePassword = function (credentials, success, fail) {
    ApiHttpUtil.post({
...
export {getCurrentUser, getUsers, register, update, updatePassword, addRole, addClaim, removeRole, removeClaim};